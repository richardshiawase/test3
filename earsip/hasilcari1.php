...
<ul class="nav nav-tabs">
  <li class="nav-item">
    <a class="nav-link active" href="menu1.php"><h6><b>Cari Dokumen</b></h6></a>
  </li>
  <li class="nav-item">
...
<!--<nav class="navbar navbar-light bg-light">
  ...
  <nav class="navbar navbar-light bg-light">
        ...
        /*
          ...
          // $regex = new MongoRegex("/\b($search|$search|$search)\b/");
      // $collection->find(array('street_name' => $regex));
          // $searchdoc = array('cari' => $search);
         /* $searchdoc = array('cari' => $regex);
          $cursor = $collection->find($searchdoc);*/
          //$cursor = $collection->find([
          //   array('$text' => $searchdoc)]);
            
          // );
          /*$result = $db->stud->find(array(
              'cari' => new \MongoDB\BSON\Regex($cursor))); */     
        /*?>
          <!DOCTYPE html>
          <html>
            <!--<div style="margin:9px 0;"></div> -->
             <!--  <div class="easyui-panel">
              <div class="easyui-pagination" data-options="">tes</div> -->
            <!-- </div> -->
          </html>
          <?php*/
          //json_encode($cursor);
          foreach ($cursor as $doc) {
            ...
            if($doc['jenisdok']=="bastk"){
                                ...
                                <!--<a class="btn btn-outline-success my-2 my-sm-0" href="editbastk1.php">Edit</a>-->
                                <!--<br/><br/>
                                <a class="btn btn-danger" href="deletekontrak.php">Delete</a>
                                <br/><br/>-->  
                                </div>
                                <?php
           }
            ...
            ?><div class="jumbotron" style="position:relative; display:inline-block; background-color:rgb(115, 255, 216)"><?php
                                ...
                                <!--<a class="btn btn-outline-success my-2 my-sm-0" href="editpo1.php">Edit</a>-->
                                <!--<br/><br/>
                                <a class="btn btn-danger" href="deletekontrak.php">Delete</a>
                                <br/><br/>-->
                                </div>
                 ...
                 ?><div class="jumbotron" style="position:relative; display:inline-block; background-color:rgb(252, 182, 193)"><?php
                                ...
                                <!--<a class="btn btn-outline-success my-2 my-sm-0" href="editstnk1.php">Edit</a>-->
                                <!--<br/><br/>
                                <a class="btn btn-danger" href="deletekontrak.php">Delete</a>
                                <br />
                                <br />-->                  
                ...
                ?><div class="jumbotron" style="position:relative; display:inline-block; background-color:rgb(240, 230, 140)"><?php
                                ...
                                <!--<a class="btn btn-outline-success my-2 my-sm-0" href="editpolis1.php">Edit</a>-->
                                <!--<br/><br/>
                                <a class="btn btn-danger" href="deletekontrak.php">Delete</a>-->
                  </div><?php
              }
                ...
                ?><div class="jumbotron" style="position:relative; display:inline-block; background-color:rgb(254, 228, 225)"><?php
                                ...
                                <!--<a class="btn btn-outline-success my-2 my-sm-0" href="editkontrak1.php">Edit</a>-->
                                <!--<br/> <br/>
                                <a class="btn btn-danger" href="deletekontrak.php">Delete</a>
                                <br />
                                <br />-->                                
