...
<form id="formpolis" action="metadatapolis.php"  method="POST" enctype="multipart/form-data">
              <div class="form-group">
               ...
               <label class="col-sm-3 control-label">Tipe Mobil:</label>
                ...
                <div class="col-sm-9">
                  <input type="text"  class="form-control" name="namaasuransi" id='namaasuransi' placeholder="" required>
                </div><br/>
                <label class="col-sm-3 control-label">Nomor Polis Asuransi:</label>
                <div class="col-sm-9">
                  <input type="text"  class="form-control" name="nopolis" id='nopolis' placeholder="" required>
                </div><br/>
                <label class="col-sm-3 control-label">Premi Asuransi:</label>
                <div class="col-sm-9">
                  <input type="text"  class="form-control" name="premi" id='premi' placeholder="" required>
                </div><br/>
                <label class="col-sm-3 control-label">Masa Berlaku Asuransi S/D:</label>
                <div class="col-sm-9">
                  <input type="date"  class="form-control" name="tglashabis" id='tglashabis' placeholder="" required>
                </div><br/>
              </div>
