...
<ul class="nav nav-tabs">
  <li class="nav-item">
   ...
   <li class="nav-item">
    <a class="nav-link active" href="upload1.php"><h6><b>Upload Dokumen</b></h6></a>
  </li>
  <li class="nav-item">
...
<form id="formpo" action="metadatapo.php"  method="POST" enctype="multipart/form-data">
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text"  class="form-control" name="namapt" id='namapt' placeholder="" required>
                </div><br/>
                <label class="col-sm-3 control-label">Nomor PO:</label>
                <div class="col-sm-9">
                  <input type="text"  class="form-control" name="nopo" id='nopo' placeholder="" required>
                </div><br/>
                <label class="col-sm-3 control-label">Tanggal PO:</label>
                <div class="col-sm-9">
                  <input type="date"  class="form-control" name="tglpo" id='tglpo' placeholder="" required>
                </div><br/>
                <label class="col-sm-3 control-label">Penandatangan PO:</label>
                <div class="col-sm-9">
                  <input type="text"  class="form-control" name="ttdpo" id='ttdpo' placeholder="" required>
                </div><br/>
                ...
                <div class="col-sm-9">
                  <input type="text"  class="form-control" name="jmlunit" id='jmlunit' placeholder="" required>
                </div><br/>
                <label class="col-sm-3 control-label">Tanggal Pengiriman Mobil:</label>
                <div class="col-sm-9">
                  <input type="date"  class="form-control" name="tglkirim" id='tglkirim' placeholder="" required>
                </div><br/>
                <label class="col-sm-3 control-label">Biaya Rental per Bulan:</label>
                <div class="col-sm-9">
                  <input type="text"  class="form-control" name="biaya" id='biaya' placeholder="" required>
                </div><br/>
                <label class="col-sm-3 control-label">Detail Pesanan:</label>
                <div class="col-sm-9">
                  <input type="text"  class="form-control" name="detail" id='detail' placeholder="" required>
                </div><br/>
              </div>
