...
<form id="formkontrak" action="metadatakontrak.php"  method="POST" enctype="multipart/form-data">
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <id="kontrak"><b>Kontrak Rental</b></id="kontrak">
                ...
                <div class="col-sm-9">
                  <input type="text"  class="form-control" name="nokontrak" id='nokontrak' placeholder="" required>
                </div><br/>
                ...
                <div class="col-sm-9">
                  <input type="text"  class="form-control" name="namattd" id='namattd' placeholder="" required>
                </div><br/>
                <label class="col-sm-3 control-label">Addendum ke-:</label>
                <div class="col-sm-9">
                  <input type="text"  class="form-control" name="addendum" id='addendum' placeholder="" required>
                </div><br/>
                <label class="col-sm-3 control-label">Tanggal Kontrak:</label>
                <div class="col-sm-9">
                  <input type="date"  class="form-control" name="tglkontrak" id='tglkontrak' placeholder="" required>
                </div><br/>
