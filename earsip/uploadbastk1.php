...
<form id="formbastk" action="metadatabastk.php"  method="POST" enctype="multipart/form-data">
              <div class="form-group">
                  <br/>
                  <label class="col-sm-3 control-label">Jenis Dokumen:</label>
                <div class="col-sm-9">
                  <id="bastk"><b>Berita Acara Serah Terima Kendaraan (BASTK)</b></id="bastk">
                ...
                <div class="col-sm-9">
                  <input type="text"  class="form-control" name="km" id='km' placeholder="" required>
                </div><br/>
               ...
               <label class="col-sm-3 control-label">Nama Pengguna Mobil:</label>
                ...
                <div class="col-sm-9">
                  <input type="date"  class="form-control" name="tglst" id='tglst' placeholder="" required>
                </div><br/>
             ...
             <!-- <form id="filebastk" class="form-horizontal " role="form" action="filebastk.php"  method="POST" > -->
                  <label class="col-sm-3 control-label">Masukkan Dokumen BASTK:</label>
                  <div class="col-sm-9">
