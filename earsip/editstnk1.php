...
<form id="formstnk" action="backeditstnk.php"  method="POST" enctype="multipart/form-data">
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text"  class="form-control" name="nopol" id='nopol' placeholder="" value="<?php echo $_SESSION['stnk_nopol'];?>">
                </div><br/>
                ...
                <div class="col-sm-9">
                  <input type="date" class="form-control" name="tglhabis" id='tglhabis' placeholder="" value="<?php echo $_SESSION['stnk_masaberlaku'];?>" required>
                </div><br/>
               </div>
